...
import (
	...
	"github.com/onomyprotocol/cosmos-sdk/x/mint/simulation"
...
func TestRandomizedGenState(t *testing.T) {
	...
	// Need to calculate what would be the inflation here
	require.Equal(t, "0.169999926644441493", mintGenesis.Minter.NextInflationRate(mintGenesis.Params, sdk.OneDec()).String(), sdk.OneDec()).String())
