...
func trimInternal(st errors.StackTrace) errors.StackTrace {
	...
	for matchesFunc(st[0],
		...
		"github.com/onomyprotocol/cosmos-sdk/types/errors.Wrap",
		"github.com/onomyprotocol/cosmos-sdk/types/errors.Wrapf",
		"github.com/onomyprotocol/cosmos-sdk/types/errors.WithType",
