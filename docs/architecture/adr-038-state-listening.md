...
Currently, KVStore data can be remotely accessed through [Queries](https://github.com/onomyprotocol/cosmos-sdk/blob/master/docs/building-modules/messages-and-queries.md#queries)
